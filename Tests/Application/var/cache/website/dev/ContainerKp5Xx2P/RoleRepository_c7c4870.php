...
class RoleRepository_c7c4870 extends \Sulu\Bundle\SecurityBundle\Entity\RoleRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer7f689 && ($this->initializer7f689->__invoke($valueHolder65c69, $this, 'findRoleById', array('id' => $id), $this->initializer7f689) || 1) && $this->valueHolder65c69 = $valueHolder65c69;

        return $this->valueHolder65c69->findRoleById($id);
    }

    public function findRoleByNameAndSystem($name, $system)
    {
        $this->initializer7f689 && ($this->initializer7f689->__invoke($valueHolder65c69, $this, 'findRoleByNameAndSystem', array('name' => $name, 'system' => $system), $this->initializer7f689) || 1) && $this->valueHolder65c69 = $valueHolder65c69;

        return $this->valueHolder65c69->findRoleByNameAndSystem($name, $system);
    }

    public function findAllRoles(array $filters = [])
    {
        $this->initializer7f689 && ($this->initializer7f689->__invoke($valueHolder65c69, $this, 'findAllRoles', array('filters' => $filters), $this->initializer7f689) || 1) && $this->valueHolder65c69 = $valueHolder65c69;

        return $this->valueHolder65c69->findAllRoles($filters);
    }

    public function getRoleNames()
    {
        $this->initializer7f689 && ($this->initializer7f689->__invoke($valueHolder65c69, $this, 'getRoleNames', array(), $this->initializer7f689) || 1) && $this->valueHolder65c69 = $valueHolder65c69;

        return $this->valueHolder65c69->getRoleNames();
    }

    public function findRoleIdsBySystem($system)
    {
        $this->initializer7f689 && ($this->initializer7f689->__invoke($valueHolder65c69, $this, 'findRoleIdsBySystem', array('system' => $system), $this->initializer7f689) || 1) && $this->valueHolder65c69 = $valueHolder65c69;

        return $this->valueHolder65c69->findRoleIdsBySystem($system);
    }

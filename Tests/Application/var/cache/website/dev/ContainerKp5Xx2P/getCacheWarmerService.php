 ...
 */
class getCacheWarmerService extends TheCocktail_Bundle_SuluSchemaOrgBundle_Tests_Application_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 6 => ($container->privates['sulu.cache.warmer.structure'] ?? $container->load('getSulu_Cache_Warmer_StructureService'));
            yield 7 => ($container->privates['doctrine.orm.proxy_cache_warmer'] ?? $container->load('getDoctrine_Orm_ProxyCacheWarmerService'));
        }, 8), true, ($container->targetDir.''.'/TheCocktail_Bundle_SuluSchemaOrgBundle_Tests_Application_KernelDevDebugContainerDeprecations.log'));
    }
}

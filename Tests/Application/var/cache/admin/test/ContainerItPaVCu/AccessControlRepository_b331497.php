...
class AccessControlRepository_b331497 extends \Sulu\Bundle\SecurityBundle\Entity\AccessControlRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer7f689 && ($this->initializer7f689->__invoke($valueHolder65c69, $this, 'findByTypeAndIdAndRole', array('type' => $type, 'id' => $id, 'roleId' => $roleId), $this->initializer7f689) || 1) && $this->valueHolder65c69 = $valueHolder65c69;

        return $this->valueHolder65c69->findByTypeAndIdAndRole($type, $id, $roleId);
    }

    public function findByTypeAndId($type, $id, $system = null)
    {
        $this->initializer7f689 && ($this->initializer7f689->__invoke($valueHolder65c69, $this, 'findByTypeAndId', array('type' => $type, 'id' => $id, 'system' => $system), $this->initializer7f689) || 1) && $this->valueHolder65c69 = $valueHolder65c69;

        return $this->valueHolder65c69->findByTypeAndId($type, $id, $system);
    }

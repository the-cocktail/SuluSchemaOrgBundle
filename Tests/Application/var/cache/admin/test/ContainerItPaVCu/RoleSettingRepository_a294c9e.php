...
class RoleSettingRepository_a294c9e extends \Sulu\Bundle\SecurityBundle\Entity\RoleSettingRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer7f689 && ($this->initializer7f689->__invoke($valueHolder65c69, $this, 'findSettingValue', array('roleId' => $roleId, 'key' => $key), $this->initializer7f689) || 1) && $this->valueHolder65c69 = $valueHolder65c69;

        return $this->valueHolder65c69->findSettingValue($roleId, $key);
    }

    public function findSetting($roleId, $key)
    {
        $this->initializer7f689 && ($this->initializer7f689->__invoke($valueHolder65c69, $this, 'findSetting', array('roleId' => $roleId, 'key' => $key), $this->initializer7f689) || 1) && $this->valueHolder65c69 = $valueHolder65c69;

        return $this->valueHolder65c69->findSetting($roleId, $key);
    }
